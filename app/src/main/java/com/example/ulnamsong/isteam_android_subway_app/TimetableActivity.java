...
public class TimetableActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mobile.isConnected() || wifi.isConnected()){
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(TimetableActivity.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
        ...
        RadioButton.OnClickListener optionOnClickListener
            ...
            public void onClick(View v) {
                if(option1.isChecked()) {
                    Toast.makeText(TimetableActivity.this, "평일", Toast.LENGTH_SHORT).show();
                    day = 0;
                } else if(option2.isChecked()) {
                    Toast.makeText(TimetableActivity.this, "토요일", Toast.LENGTH_SHORT).show();
                    day = 1;
                } else {
                    Toast.makeText(TimetableActivity.this, "일/공휴일", Toast.LENGTH_SHORT).show();
                    day = 2;
                }
            }
        };
        ...
        RadioButton.OnClickListener optionOnClickListener2
            ...
            public void onClick(View v) {
                if(option4.isChecked()) {
                    Toast.makeText(TimetableActivity.this, "상행", Toast.LENGTH_SHORT).show();
                    updn = 0;
                } else if(option5.isChecked()) {
                    Toast.makeText(TimetableActivity.this, "하행", Toast.LENGTH_SHORT).show();
                    updn = 1;
                }
            }
        };
        ...
        stnIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TimetableActivity.this, Search2Activity.class);
