...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favoriteBtn = (ImageButton) findViewById(R.id.favorite);
        ...
        favoriteBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e("Favorite", "Favorite Button Clicked.");
                try {
                    Log.e("File Open", "Try File Open.");
                    ...
                    String s = "";
                    int charRead;
                    Log.e("charRead : ", r_InputRead.read(inputBuffer) + " // ");
                    if((charRead = r_InputRead.read(inputBuffer)) > 0) {
