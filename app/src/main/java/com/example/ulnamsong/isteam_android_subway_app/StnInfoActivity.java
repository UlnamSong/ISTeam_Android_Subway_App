 ...
 */
public class StnInfoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stninfo);
        Log.e("열차정보 액티비티", "열차정보액티비티실행됨");
        ...
        favoriteBtn = (Button) findViewById(R.id.favorite1);
        ...
        if(mobile.isConnected() || wifi.isConnected()){
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(StnInfoActivity.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
                    ...
                    if (temp.equals(LineName)) {
                        ...
                        if(updn[i].equals("(상행)") || updn[i].equals("(내선)")) {
                            if (ori[i] != null) {
                                ...
                                AlertDialog.Builder alert = new AlertDialog.Builder(StnInfoActivity.this);
                                alert.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.dismiss();
        ...
        timetable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StnInfoActivity.this, TimetableActivity.class);
        ...
        editName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StnInfoActivity.this, SearchActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        traininfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(StnInfoActivity.this, FirstLastActivity.class);
        ...
        favoriteBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(StnInfoActivity.this, "즐겨찾기 추가 버튼 눌려짐", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        refreshBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mobile.isConnected() || wifi.isConnected()) {
                    ProgressDialog dialog = new ProgressDialog(StnInfoActivity.this, ProgressDialog.THEME_DEVICE_DEFAULT_LIGHT);
        ...
        kakaoshareBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StnInfoActivity.this, MyActivity.class);
